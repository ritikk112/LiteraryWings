...
$password = "";
$db = "demo";
if($_POST['cname'] == NULL || $_POST['cpwd'] == NULL){
  exit("Please input both the fields");
}
$uname = $_POST['cname'];
$pwdd = $_POST['cpwd'] ;
$cpwdd = $_POST['ccpwd'];
...
$sql = "INSERT INTO final VALUES ('$uname', '$pwdd')";
if($conn->query($sql)){
...
<html lang="en">
    ...
    width: auto;">
            ...
            <button class = "submit" style = "display: flex; align-items: center; margin:50px 0px 0px 350px">OK</button></a>
        </div>
        <br>
      </section>
